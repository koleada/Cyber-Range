...
Group policy is one of the most powerful components of Active Directory. We touched on it briefly regarding the identity model, but here we will go a lot further. Specifically, this file will provide a nice overview of Group Policy and the foundational concepts relating to it.
...
- What Group Policy is and what probelms it helps solve
- Group Policy Heirarchy
- Inheritance, Enforcement, and Blocking
- Security Filtering
- WMI Filtering
- Group Policy version control 
